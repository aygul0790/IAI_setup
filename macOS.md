...
``` bash
/bin/bash -c "$(curl -fsSL https://raw.githubusercontent.com/aygul0790/IAI_setup/refs/heads/main/utils/macos_list_processor_type.sh"
```
...
When typing a password in the Terminal, you will **not** get a visual feedback (something like `*****`), this is **normal**!! Type the password and confirm by typing `Enter`.
...
``` bash
pip install -r https://raw.githubusercontent.com/aygul0790/IAI_setup/refs/heads/main/requirements/apple_silicon.txt
```
</details>
...
``` bash
pip install -r https://raw.githubusercontent.com/aygul0790/IAI_setup/refs/heads/main/requirements/apple_intel.txt
```
</details>
