...
![Windows task manager](https://github.com/aygul0790/IAI_setup/blob/main/images/windows_task_manager.png)
...
![Update WSL from version 1 to 2](https://github.com/aygul0790/IAI_setup/blob/main/images/windows_update_wsl.png)
...
- Choose a **username**:
    ...
    - for example: `iai_course` or your `firstname`
- Choose a **password**
...
![VS Code installation options](https://github.com/aygul0790/IAI_setup/blob/main/images/windows_vscode_installation.png)
...
![WSL Ubuntu Remote](https://github.com/aygul0790/IAI_setup/blob/main/images/windows_remote_wsl.png)
...
![Windows Terminal Settings](https://github.com/aygul0790/IAI_setup/blob/main/images/windows_terminal_settings.png)
...
![Windows Terminal JSON settings file](https://github.com/aygul0790/IAI_setup/blob/main/images/windows_terminal_settings_json.png)
...
![VS Code Live Share](https://github.com/aygul0790/IAI_setup/blob/main/images/vscode_live_share.png)
...
![Ubuntu terminal with OhMyZsh](https://github.com/aygul0790/IAI_setup/blob/main/images/oh_my_zsh.png)
...
To check if this worked, run `python --version`. If you see `3.10.6`, perfect! If not, ask a teacher that will help you debug the problem thanks to `pyenv versions` and `type -a python` (`python` should be using the `.pyenv/shims` version first).
...
```bash
pyenv virtualenv 3.10.6 iai_course
```
...
Then let's install some packages for the first weeks of the course:

``` bash
pip install -r https://raw.githubusercontent.com/aygul0790/IAI_setup/refs/heads/main/requirements/linux.txt
```
...
![Jupyter page](https://github.com/aygul0790/IAI_setup/blob/main/images/wsl_jupyter_notebook.png)
...
![How to add a shortcut to Ubuntu file system on Windows](https://github.com/aygul0790/IAI_setup/blob/main/images/windows_ubuntu_file_system_shortcut.gif)
...
![How to pin an app to the taskbar in Windows](https://github.com/aygul0790/IAI_setup/blob/main/images/windows_taskbar.png)
...
If you are done with your setup, please ask around if some classmates need some help with theirs (macOS, Linux, Windows). 

Otherwise, you can also wait for others while working on this [Tic-Tac-Toe Kata](https://www.codewars.com/kata/5b817c2a0ce070ace8002be0/train/python)
